...
export default function DraftFormClient({
  ...
  if (initializing) {
    return <div style={{ maxWidth: 760, margin: "40px auto", padding: 16 }}>加载中...</div>;
  }
    ...
    <div style={{ maxWidth: 760, margin: "40px auto", padding: 16 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
        <h1 style={{ fontSize: 22, fontWeight: 800, margin: 0 }}>
          {mode === "edit" ? "编辑草稿流水" : "登记草稿流水"}
        </h1>
        <div style={{ marginLeft: "auto" }}>
          <a href="/drafts" style={{ padding: "8px 12px", border: "1px solid #ddd", borderRadius: 6, textDecoration: "none" }}>
            ← 返回列表
          </a>
        </div>
      </div>
